    ...
    <main className="container-fluid">
      <section className="row align-items-center">
        ...
        <div className="col-xs-5 col-md col-sm-12">
          ...
          <p>
            Somos um plataforma integrada tanto no formato web como mobile.
            Ainda estamos em fase de desenvolvimento. Nosso principal objetivo é
            fornece um canal direto de comunicação entre possíveis doadoras de
            leite materno e os bancos de leite.
          </p>
          <p>
