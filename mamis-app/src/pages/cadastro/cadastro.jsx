            ...
            <form >
                <div className="input-group">
                    <div className="input-box">
                        ...
                        <input id='firstname' onKeyUp={event => Checker(event)} maxLength="30" type="text" name="firstname" placeholder="Nome" required></input>
                        <span id="firstnameValidation"></span>
                    </div>
                    <div className="input-box">
                        {/*  sobrenome */}
                        <label htmlFor="lastname" ></label>
                        <input id='lastname' onKeyUp={event => Checker(event)} maxLength="50" type="text" name="lastname" placeholder="Sobrenome" required></input>
                        <span id="lastnameValidation"></span>
                    </div>
                    <div className="input-box">
                        {/*  CPF */}
                        <label htmlFor="CPF" ></label>
                        <input id='CPF' maxLength="14" onKeyUp={event => CPFMask(event)} type="text" name="CPF" placeholder="CPF" required></input>
                    ...
                    <div className="input-box">
                        ...
                        <input maxLength="50" id='password' type="password" name="password" placeholder="Senha" required></input>
                    </div>
                    {/* confirme a senha */}
                    <div className="input-box">
                ...
                <div className='rodape'>
                    <div className="buttoes">
                        <input type="reset" value="Limpar" onClick={event => CheckerClear(event)} />
                        <input type="submit" onSubmit={event => CheckerFinal(event)} target="_blank" value="Enviar" />
