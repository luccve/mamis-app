        ...
        <main className="container-fluid">
            ...
            <section className="row align-items-center">
                ...
                <div className='col-xs-5 col-md col-sm-12'>
                    ...
                    <p>
                                O projeto e desenvolvido por um grupo
                                de estudantes do IFPE junto com uma
                                equipe de colaborados voluntários. Por
                                aqui temos um lema "Apoiar o mamis é
                                salvar vidas".
                    </p>
                    <p>
            ...
            <section className="row align-items-center">
                ...
                <div className='col-xs-5 col-md col-sm-12'>
                    ...
                    <p>
                               Apesar de ser um projeto que estimula a doação de leite materno
                               toda forma de ajuda é bem vinda. Hospitais que fazem a coleta necessitam de doação de potes,
                               para saber a melhor opção e aonde encontra-los <a target="_blank" href="http://rblh.fiocruz.br/como-coletar-o-leite-humano-para-doacao">Clique aqui</a>
                    </p>
