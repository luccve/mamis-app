        ...
        <main className="container-fluid">
            <div className="row align-items-center">
                ...
                <div className="col-12">
                    <h2>A mãe lactante além de estar saudável deve ter em mãos a documentação listada abaixo para a realização do cadastro. </h2>
                    <table className="table table-striped  table-bordered table-dark">
                        ...
                        <tbody>
                            ...
                            <td scope='row'>Recebeu transfusão de sangue nos ultimos 5 anos?</td>
